...
class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("");
        System.out.println("");
        int player_random1 = 52;
        int player_random2 = 52;

        while (player_random1 >= 12 || player_random2 >= 12 || player_random1 < 3 || player_random2 < 3) {
            player_random1 = (int) (Math.random() * 52);
            player_random2 = (int) (Math.random() * 52);
        }
        ...
        int dealer_random1 = 52;
        int dealer_random2 = 52;

        while (dealer_random1 >= 12 || dealer_random2 >= 12 || dealer_random1 < 3 || dealer_random2 < 3) {
            dealer_random1 = (int) (Math.random() * 52);
            dealer_random2 = (int) (Math.random() * 52);
        }
        ...
        if (hidden == true) {
            ...
            System.out.println("The dealer has a " + dealer_random1 + " the other card is hidden");
        ...
        System.out.println("Would you like to hit, stay or surrender?");
        player_preference = in.nextLine();

        while (player_preference.equals("hit")) {
            int player_random3 = 52;
            while (player_random3 >= 12 || player_random3 < 3) {
                player_random3 = (int) (Math.random() * 52);
            }
        ...
        if (player_preference.equals("stay")) {
         ...
         if (player_preference.equals("surrender")) {
